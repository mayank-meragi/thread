...
export function FeedsPage() {
  ...
  const fetchFullArticle = useCallback(async (entry: FeedEntryRecord) => {
    ...
    try {
      ...
      const articleHtml = sanitizeFeedHtml(article.contentHtml)
